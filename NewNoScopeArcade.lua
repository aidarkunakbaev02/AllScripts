...
NotificationLibrary:SendNotification("Info", "Onetap Loading...", 3)

wait(5) 

NotificationLibrary:SendNotification("Success", "Onetap Loaded!", 3)



NotificationLibrary:SendNotification("Info", "Trying to load Cfg Manager", 3)

wait(6)

NotificationLibrary:SendNotification("Error", "Error Cfg manager not loaded trying launch", 3)
...
NotificationLibrary:SendNotification("Info", "Onetap launched!", 3)
